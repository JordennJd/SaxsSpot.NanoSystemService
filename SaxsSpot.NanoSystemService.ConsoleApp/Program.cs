...
using SaxsSpot.NanoSystemService.Engine.Services;
...
public class Program
{
    public static async Task Main(string[] args)
    {
        ...
        var serviceProvider = new ServiceCollection()
            ...
            .AddScoped<INanoSystemGenerationManager, NanoSystemGenerationManager>()
        ...
        var service = scope.ServiceProvider.GetService<INanoSystemGenerationManager>();
